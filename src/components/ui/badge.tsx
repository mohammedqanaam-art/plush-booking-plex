...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-primary/35 bg-primary/15 text-primary hover:bg-primary/25",
        secondary: "border-primary/20 bg-secondary/70 text-secondary-foreground hover:border-primary/35",
