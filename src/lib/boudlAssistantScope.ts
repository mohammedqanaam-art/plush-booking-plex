...
const clearOutsidePattern = /(?:^|\s)(?:برمجه|كود|شفرة|جافاسكربت|بايثون|سياسه دوليه|رئيس|وزير|انتخابات|الانتخابات|كره القدم|مباراه|المباراه|دوري|الدوري|اسهم|الاسهم|بورصه|البورصه|ذهب|عملات|طب|دواء|تشخيص|مستشفي|طقس|الطقس|اخبار|الاخبار|وصفه طبخ|قصيده|اغنيه|programming|javascript|python|politics|president|election|football|stocks?|crypto|medical|diagnosis|weather|news|recipe|poem|song)(?=\s|$)/i;
