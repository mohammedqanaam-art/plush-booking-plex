...
const hospitalityPattern = /(?:^|\s)(?:احجز|الحجز|الحجوزات|الفندق|الفنادق|الفروع|الغرف|الاجنحه|الخدمات|المرافق|الموقع|فندق|فندقا|فنادق|فرع|فروع|حجز|حجوزات|غرف|غرفه|اجنحه|جناح|اقامه|ضيف|نزيل|وصول|مغادره|الغاء|الغاء الحجز|سياسه|خدمات|مرافق|مسبح|مطعم|افطار|سبا|نادي|مواقف|موقع|عنوان|رقم التواصل|رقم الفندق|سعر الغرفه|توفر الغرف|hotel|hotels|branch|branches|book|booking|reservation|room|suite|stay|guest|check in|check out|cancellation|facility|facilities|pool|restaurant|breakfast|spa|parking)(?=\s|$)/i;
...
export const boudlScopeReply = (scope: BoudlAssistantScope) => scope === "greeting"
  ? "أهلًا بك في مجموعة بودل للضيافة. أساعدك في كتابة الأسماء بالإنجليزية وحساب المبالغ والخصومات، وفنادق بودل وبريرا وعابر ونارسيس وزمن. اكتب اسمًا أو جرّب: 2000 خصم 20."
  : "أساعدك في فنادق مجموعة بودل للضيافة، وكتابة الأسماء بالإنجليزية وحساب المبالغ والخصومات. اكتب الاسم فقط، أو مثلًا: 2000 خصم 20. وللسؤال الفندقي اذكر الفرع أو الخدمة.";
