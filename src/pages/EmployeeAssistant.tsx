...
const initialMessage = "أهلًا بك. أساعدك في كتابة الأسماء بالإنجليزية وحساب المبالغ والخصومات، وأوجّهك في الشكاوى والطلبات والسياسات ومعلومات فروع BHG. جرّب: 2000 خصم 20 للنسبة، أو 2000 خصم 20 ريال للمبلغ الثابت.";
